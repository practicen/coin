...
class TopViewController: UIViewController, UITextFieldDelegate, GADBannerViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-2313732454636490/3838349606"
    ...
    @IBAction func privacyUrl(_ sender: Any) {
        guard let url = URL(string: "https://github.com/practicen/saito-tap/blob/main/saito%20tap%20docs:Privacy%20Policy/saitotap%20Praivacy%20Policy") else { return }
